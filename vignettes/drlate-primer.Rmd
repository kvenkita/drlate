...
Section 6. Each piece is an "effect of $Z$ on
...
genuinely like-for-like comparison (every row adjusts for covariates only
...
exists — use the bootstrap there).
...
fixtures generated by Stata's `drlate` *and* `kappalate` on the SIPP
extract used in the original help files.
