...
All extensions are validated by Monte Carlo; see the *Validation report
and peer review* article on the package website.
...
instrument) and flags weakness below F = 10. Two additional inference
tools are available:
...
Section 5 of the paper turns this into a heterogeneity-robust Hausman
test, implemented here (it is not available in the Stata package):
...
The simulated treatment is genuinely confounded, and the test rejects.
